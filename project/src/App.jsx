...
const navigate = useNavigate();
  ...
  return (
    <>
      <div className="flex h-screen w-screen bg-gradient-to-br from-[#556B2F] to-[#FAEDCE]">
        <div className="flex flex-col items-center w-1/2 pl-20">
        ...
        <div className='flex flex-col items-center justify-center w-1/2 p-30'>
